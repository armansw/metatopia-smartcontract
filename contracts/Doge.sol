...
contract Doge is IGame, ERC721Enumerable, Ownable, Pausable, Whitelisted {
    // mint price
    ...
    constructor(
        ...
        // Dog
        claimAmount[2] = 21 ether;
        // Veteranians
        claimAmount[3] = 28.125 ether;
        //Alpha
        claimAmount[4] = 35 ether;

        // 100% = 10000
        harvestRiskRate[1] = 5000;// Cat
        harvestRiskRate[2] = 0; // Dog
        harvestRiskRate[3] = 0; // Veteranians
        harvestRiskRate[4] = 0; // Alpha

        harvestRiskDistributeRate[1] = 7500;// Cat   100% = 10000
        harvestRiskDistributeRate[2] = 1875; // Dog
        harvestRiskDistributeRate[3] = 625; // Veteranians
        harvestRiskDistributeRate[4] = 0; // Alpha 
        // Total harvest rate : 10000 = 100%

        // 100% = 10000
        unstakeRiskRate[1] = 1000;// Cat
        unstakeRiskRate[2] = 1000; // Dog
        unstakeRiskRate[3] = 0; // Veteranians
    ...
    function setRiskRate(uint8 nftTypeIndex, uint8 rate) public onlyOwner {
